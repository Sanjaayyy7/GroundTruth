...
- **claim:C7** (supported_observation) Small local zero-shot LLM judges (4B/8B) are far less precise than the rules: the best measured arm …
  - blocking: two small local models; corpus v1 labels (5 categories); rules were authored against this corpus, so they keep home-field advantage in every arm
